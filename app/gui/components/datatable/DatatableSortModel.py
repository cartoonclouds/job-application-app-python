...
class DatatableSortModel(QSortFilterProxyModel):
    """_summary_


    URL: https://github.com/pyside/Examples/blob/master/examples/itemviews/basicsortfiltermodel.py
         https://doc.qt.io/qtforpython/PySide6/QtCore/QSortFilterProxyModel.html
         https://doc.qt.io/qtforpython/overviews/qtwidgets-itemviews-customsortfiltermodel-example.html

    Args:
        QSortFilterProxyModel (_type_): _description_
    """
    ...
    #     super(DatatableSortModel, self).setFilterKeyColumn(col)
